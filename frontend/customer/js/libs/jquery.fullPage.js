...
(function($) {
	$.fn.fullpage = function(options) {
		...
		*/
        ...
        /**
         * Switches off the stopTouchScroll flag
         */
        $.fn.fullpage.stopTouchScroll = function(){
            stopTouchScroll = true;
        }

        /**
         * Switches on the stopTouchScroll flag
         */
        $.fn.fullpage.startTouchScroll = function(){
            stopTouchScroll = false;
        }
        
        // flag to entirely stop scrolling using touch if is it active. (will be used for noUiSlider thingy)
        var stopTouchScroll = false;
